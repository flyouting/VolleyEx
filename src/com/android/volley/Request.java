...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    /**
     * 请求方法 目前支持 GET, POST, PUT, and DELETE, HEAD, OPTIONS, TRACE, PATH Request
     * method of this request. Currently supports GET, POST, PUT, DELETE, HEAD,
