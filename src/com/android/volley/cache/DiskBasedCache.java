...
public class DiskBasedCache implements Cache {
    ...
    public synchronized void initialize() {
        ...
        for (File file : files) {
            ...
            try {
                ...
                entry.size = (int) (file.length() - cis.bytesRead);
                VolleyLog.e("new entry init, key is " + entry.key + " size is " + entry.size);
    ...
    public synchronized void put(String key, Entry entry) {
        ...
        VolleyLog.e("new entry is added, key is " + key + " size is " + entry.data.length);
        File file = getFileForKey(key);
        try {
